...
is primarily written in C++20 (requiring at least Clang 16 or GCC 11.1). GoByte Core uses the GNU Autotools build system.
...
GoByte Core extends Bitcoin Core through composition, using a layered architecture:
...
gh api repos/gobytecoin/gobyte/actions/jobs/<JOB_ID>/logs
