...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x"); // 395750

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x"); // 395750
        ...
        vSeeds.emplace_back("testnet-seed.gobytedot.network"); // Just a static list of stable node(s), only supports x9
